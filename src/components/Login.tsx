    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4" id="login-container">
      ...
      >
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 p-8 text-white relative">
          <div className="absolute right-6 top-6 bg-white/10 p-3 rounded-full">
            <GraduationCap className="h-8 w-8" />
          </div>
          <h2 className="text-2xl font-bold tracking-tight">
            {isSignUp ? '新規アカウント作成' : 'システムにサインイン'}
          </h2>
          <p className="mt-2 text-indigo-100 text-sm">
            {isSignUp 
              ? '模試成績と日常学習を効果的に可視化・管理しましょう。' 
              : '水戸葵陵高校 模試成績・学習管理システムへようこそ。'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6" id="login-form">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-3 py-2.5 border border-gray-200 rounded-lg text-gray-900 bg-gray-50/50 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all text-sm"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1">
                  ...
                  <input
                    ...
                    className="block w-full px-3 py-2.5 border border-gray-200 rounded-lg text-gray-900 bg-gray-50/50 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white font-mono transition-all text-sm"
                  />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="block w-full px-2.5 py-2 border border-gray-200 rounded-lg text-gray-800 bg-white text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                      >
          ...
          >
            {loading ? (
              ...
              <>
                <span>{isSignUp ? 'アカウント作成' : 'サインイン'}</span>
          ...
          <div className="text-center">
            ...
            >
              {isSignUp ? 'すでにアカウントをお持ちですか？ ログインへ' : '新しくアカウントを作りますか？ 新規登録へ'}
            </button>
          </div>
        </form>
      </motion.div>
